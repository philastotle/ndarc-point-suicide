...
# ex_days
ggplotly(
ggplot(data = suicide_thoughts_df, aes(x = ex_days, fill = sex)) + 
  ggtitle("ex_days") + 
  labs(x = "Age", y = "Number of respondents") +
  geom_histogram(bins = 1
                 , alpha = 0.7
...
# falls_since_op_num
ggplotly(
ggplot(data = suicide_thoughts_df, aes(x = falls_since_op_num, fill = sex)) + 
  ggtitle("falls_since_op_num") + 
  labs(x = "falls_since_op_num", y = "Number of respondents") +
